...
<style>
/* ... (include all the CSS from the TimeLogGuide.php above) ... */
.user-guide-overlay {
    position: fixed;
    top: 0;
    left: 0;
...
const guideSteps = [
    ...
    },
    {
        ...
        content: "Use these color-coded buttons to filter employees. Red shows hours owed, green shows hours worked. Click again to toggle filters off.",
